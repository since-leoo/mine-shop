...
namespace Plugin\Since\GroupBuy\Interface\Request;
...
use Plugin\Since\GroupBuy\Interface\Dto\GroupBuyDto;
...
class GroupBuyRequest extends BaseRequest
{
    ...
    {
        return [
            'title' => '活动标题', 'description' => '活动描述',
            'product_id' => '商品', 'sku_id' => 'SKU',
            'original_price' => '原价', 'group_price' => '团购价',
            'min_people' => '最少成团人数', 'max_people' => '最多成团人数',
            'start_time' => '开始时间', 'end_time' => '结束时间',
            'group_time_limit' => '成团时限', 'status' => '活动状态',
            'total_quantity' => '总库存', 'sort_order' => '排序',
            'is_enabled' => '是否启用', 'rules' => '活动规则',
            'images' => '活动图片', 'remark' => '备注',
        ];
    }
