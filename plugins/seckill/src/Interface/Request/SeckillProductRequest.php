...
class SeckillProductRequest extends BaseRequest
{
    ...
    public function listRules(): array { return ['session_id' => ['nullable', 'integer', 'min:1'], 'activity_id' => ['nullable', 'integer', 'min:1'], 'product_id' => ['nullable', 'integer', 'min:1'], 'is_enabled' => ['nullable', 'boolean'], 'page' => ['nullable', 'integer', 'min:1'], 'page_size' => ['nullable', 'integer', 'min:1', 'max:100']]; }
    public function storeRules(): array { return ['activity_id' => ['required', 'integer', 'min:1', 'exists:seckill_activities,id'], 'session_id' => ['required', 'integer', 'min:1', 'exists:seckill_sessions,id'], 'product_id' => ['required', 'integer', 'min:1', 'exists:products,id'], 'product_sku_id' => ['required', 'integer', 'min:1', 'exists:product_skus,id'], 'original_price' => ['required', 'numeric', 'min:0.01'], 'seckill_price' => ['required', 'numeric', 'min:0.01', 'lt:original_price'], 'quantity' => ['required', 'integer', 'min:1'], 'max_quantity_per_user' => ['nullable', 'integer', 'min:1'], 'sort_order' => ['nullable', 'integer', 'min:0'], 'is_enabled' => ['nullable', 'boolean']]; }
    public function updateRules(): array { return ['original_price' => ['nullable', 'numeric', 'min:0.01'], 'seckill_price' => ['nullable', 'numeric', 'min:0.01'], 'quantity' => ['nullable', 'integer', 'min:1'], 'max_quantity_per_user' => ['nullable', 'integer', 'min:1'], 'sort_order' => ['nullable', 'integer', 'min:0'], 'is_enabled' => ['nullable', 'boolean']]; }
    ...
    public function attributes(): array { return ['activity_id' => '活动ID', 'session_id' => '场次ID', 'product_id' => '商品ID', 'product_sku_id' => '商品SKU ID', 'original_price' => '原价', 'seckill_price' => '秒杀价', 'quantity' => '库存数量', 'max_quantity_per_user' => '每人限购数量', 'sort_order' => '排序', 'is_enabled' => '是否启用', 'products' => '商品列表']; }
