 ...
 * @coversNothing
 */
final class CouponEntityTest extends TestCase
{
    public function testConstructorDefaults(): void
    {
        $c = new CouponEntity();
        self::assertSame(0, $c->getId());
        self::assertSame('active', $c->getStatus());
        self::assertSame(0, $c->getUsedQuantity());
    }

    public function testGettersSetters(): void
    {
        $c = $this->makeCoupon();
        self::assertSame(1, $c->getId());
        self::assertSame('满减券', $c->getName());
        self::assertSame('fixed', $c->getType());
        self::assertSame(1000, $c->getValue());
        self::assertSame(5000, $c->getMinAmount());
        self::assertSame(100, $c->getTotalQuantity());
        self::assertSame(3, $c->getPerUserLimit());
    }
    ...
    public function testActivateDeactivate(): void
    {
        $c = $this->makeCoupon();
        $c->deactivate();
        self::assertSame('inactive', $c->getStatus());
        $c->activate();
        self::assertSame('active', $c->getStatus());
    }
    ...
    public function testCanMemberReceive(): void
    {
        ...
        self::assertTrue($c->canMemberReceive(0));
        self::assertTrue($c->canMemberReceive(2));
        self::assertFalse($c->canMemberReceive(3));
    }
    ...
    public function testCanMemberReceiveNoLimit(): void
    {
        ...
        self::assertTrue($c->canMemberReceive(999));
    }
    ...
    public function testCalculateDiscountFixed(): void
    {
        ...
        $c->setType('fixed');
        $c->setValue(1000);
        self::assertSame(1000, $c->calculateDiscount(10000));
    }
    ...
    public function testResolveExpireAt(): void
    {
        ...
        self::assertSame('2026-03-20', $expire->toDateString());
    }
    ...
    public function testToArray(): void
    {
        $c = $this->makeCoupon();
        $arr = $c->toArray();
        self::assertSame('满减券', $arr['name']);
        self::assertSame('fixed', $arr['type']);
        self::assertSame(1000, $arr['value']);
