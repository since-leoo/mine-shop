 ...
 * @coversNothing
 */
final class DomainMemberPointsServiceTest extends TestCase
{
    ...
    public function testCalculatePurchasePointsBasicFormula(): void
    {
        ...
        self::assertSame(10000, $this->service->calculatePurchasePoints(10000, 1.0));
    }

    public function testCalculatePurchasePointsWithHigherPointRate(): void
    {
        $this->mallSettingService->method('member')->willReturn($this->makeMemberSetting(100, 100));
        self::assertSame(15000, $this->service->calculatePurchasePoints(10000, 1.5));
    }

    public function testCalculatePurchasePointsFloorsDown(): void
    {
        $this->mallSettingService->method('member')->willReturn($this->makeMemberSetting(100, 100));
        self::assertSame(999, $this->service->calculatePurchasePoints(999, 1.0));
    }

    public function testCalculatePurchasePointsZeroAmount(): void
    {
        $this->mallSettingService->method('member')->willReturn($this->makeMemberSetting(100, 100));
        self::assertSame(0, $this->service->calculatePurchasePoints(0, 1.0));
    }
    ...
    public function testGrantRegisterPointsReturnsEvent(): void
    {
        ...
        self::assertSame('points', $event->walletType);
        self::assertSame(100, (int) $event->changeAmount);
        self::assertSame('register', $event->source);
    }
    ...
    public function testGrantRegisterPointsReturnsNullWhenConfigIsZero(): void
    {
        ...
        self::assertNull($this->service->grantRegisterPoints(1));
    }
    ...
    public function testGrantPurchasePointsReturnsEventWithLevel(): void
    {
        ...
        self::assertInstanceOf(MemberBalanceAdjusted::class, $event);
        self::assertSame(15000, (int) $event->changeAmount);
        self::assertSame('purchase_reward', $event->source);
    }
    ...
    public function testGrantPurchasePointsReturnsNullWhenResultIsZero(): void
    {
        ...
        $this->walletService->expects(self::never())->method('getEntity');
        self::assertNull($this->service->grantPurchasePoints(1, 10000, 'ORD003'));
    }
    ...
    public function testDeductPurchasePointsReturnsEventForFullDeduction(): void
    {
        ...
        self::assertInstanceOf(MemberBalanceAdjusted::class, $event);
        self::assertSame(-200, (int) $event->changeAmount);
        self::assertSame('purchase_refund', $event->source);
    }
    ...
    public function testDeductPurchasePointsCapsAtBalance(): void
    {
        ...
        $this->walletService->expects(self::once())->method('getEntity')->willReturn($walletEntity);
        $this->walletService->expects(self::once())->method('saveEntity');
    ...
    public function testDeductPurchasePointsReturnsNullWhenBalanceIsZero(): void
    {
        ...
        $this->walletService->expects(self::never())->method('saveEntity');

        self::assertNull($this->service->deductPurchasePoints(1, 100, 'ORD007'));
    }
    ...
    public function testDeductPurchasePointsReturnsNullWhenAmountIsZero(): void
    {
        ...
        self::assertNull($this->service->deductPurchasePoints(1, 0, 'ORD008'));
    }
