...

{
...

    {
        ...
        $service = new AppAfterSaleCommandService($repository, $queryService, $this->createMock(DomainAfterSaleRefundService::class));
...

    {
        ...
        $repository->expects(self::once())
            ...
            ->with(self::callback(static function ($entity): bool {
                ...
                return $entity->getId() === 90
                    ...
                    && $entity->getStatus() === 'refunding'

                    && $entity->getRefundStatus() === 'processing';
        ...
        $queryService->expects(self::once())
            ...
            ->willReturn(['id' => 90, 'status' => 'refunding']);



        $service = new AppAfterSaleCommandService($repository, $queryService, $refundService);

        $result = $service->refund($input);



        self::assertSame('refunding', $result['status']);
