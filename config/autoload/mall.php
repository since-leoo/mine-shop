    ...
    'groups' => [
        ...
        'payment' => [
            ...
            'settings' => [
                ...
                'mall.payment.alipay_enabled' => [
                    'label' => '启用支付宝支付',
                    'description' => '关闭后前台不会展示支付宝通道。',
                    'type' => 'boolean',
                    'default' => false,
                    'sort' => 30,
                ],
                'mall.payment.alipay_config' => [
                    'label' => '支付宝配置',
                    'description' => 'yansongda/pay 适配的密钥、证书等配置，JSON 格式。',
                    'type' => 'json',
                    'is_sensitive' => true,
                    'meta' => [
                        'component' => 'form',
                        'display' => 'dialog',
                        'trigger_key' => 'mall.payment.alipay_enabled',
                        'trigger_value' => true,
                        'button_label' => '密钥设置',
                        'fields' => [
                            [
                            ...
                            [
                                ...
                                'label' => '应用公钥证书',
                                'placeholder' => 'storage/cert/appCertPublicKey.crt',
                                'required' => true,
                            ],
                            [
                                'key' => 'app_private_key',
                            ...
                            [
                                ...
                                'label' => '支付宝公钥证书',
                                'placeholder' => 'storage/cert/alipayCertPublicKey.crt',
                                'required' => true,
                            ],
                            [
                                'key' => 'alipay_root_cert_path',
                                'label' => '支付宝根证书',
                                'placeholder' => 'storage/cert/alipayRootCert.crt',
                                'required' => true,
                            ],
                            [
                                'key' => 'notify_url',
                                'label' => '支付回调地址',
                                'placeholder' => 'https://example.com/pay/alipay/notify',
                                'required' => true,
                            ],
                            [
                                'key' => 'return_url',
                                'label' => '前端回跳地址',
                                'placeholder' => 'https://example.com/pay/alipay/return',
                            ],
                        ],
                    ],
                    'default' => [
