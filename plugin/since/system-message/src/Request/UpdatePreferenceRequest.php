...
class UpdatePreferenceRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'channel_preferences.socketio' => ['boolean'],
    ...
    public function messages(): array
    {
        return [
            ...
            'channel_preferences.socketio.boolean' => 'Socket.IO通知设置必须是布尔值',
            'channel_preferences.websocket.boolean' => 'WebSocket通知设置必须是布尔值',
    ...
    public function attributes(): array
    {
        return [
            ...
            'channel_preferences.socketio' => 'Socket.IO通知',
            'channel_preferences.websocket' => 'WebSocket通知',
    ...
    public function withValidator($validator): void
    {
        $validator->after(function ($validator) {
            ...
            // 验证免打扰时间设置
            if (isset($data['do_not_disturb_start']) && isset($data['do_not_disturb_end'])) {
