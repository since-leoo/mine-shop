...
class SystemMessage
{
    ...
    public static function sendToUser(
        ...
        $data = array_merge([
            ...
            'content' => $content,
            'type' => $type,
            'recipient_type' => Message::RECIPIENT_USER,
    ...
    public static function sendToRole(
        ...
        $data = array_merge([
            ...
            'content' => $content,
            'type' => $type,
            'recipient_type' => Message::RECIPIENT_ROLE,
     ...
     * 调度消息（定时发送）
     */
    public static function schedule(array $data, \Carbon\Carbon $scheduledAt): Message
    {
        $data['scheduled_at'] = $scheduledAt;
        $data['status'] = Message::STATUS_SCHEDULED;
    ...
    public static function notify(
        ...
        if ($userIds !== null) {
            $userIds = is_array($userIds) ? $userIds : [$userIds];
            $data['recipient_type'] = Message::RECIPIENT_USER;
            $data['recipient_ids'] = $userIds;
        } else {
            $data['recipient_type'] = Message::RECIPIENT_ALL;
        }

        return static::sendToUser($userIds ?? [], $title, $content, Message::TYPE_SYSTEM, [
            'channels' => $channels
        ]);
    }
    ...
    public static function announce(
        ...
        return static::sendToAll($title, $content, Message::TYPE_ANNOUNCEMENT, [
            'channels' => $channels
        ]);
    }
    ...
    public static function alert(
        ...
        if ($userIds !== null) {
            return static::sendToUser($userIds, $title, $content, Message::TYPE_ALERT, [
                'channels' => $channels,
                'priority' => 5
            ]);
        }
        
        return static::sendToAll($title, $content, Message::TYPE_ALERT, [
            'channels' => $channels,
            'priority' => 5
        ]);
    }
    ...
    public static function remind(
        ...
        return static::sendToUser($userIds, $title, $content, Message::TYPE_REMINDER, $options);
    }
