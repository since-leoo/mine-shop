 ...
 * 首页数据聚合应用服务.
 */
final class HomeQueryApiService
{
    public function __construct(
        private readonly ProductQueryApiService $productQueryService,
    ...
    {
        $featured = $this->productQueryService->list(['is_recommend' => true, 'status' => 'active'], 1, 10)['list'];
        $hot = $this->productQueryService->list(['is_hot' => true, 'status' => 'active'], 1, 10)['list'];
        $new = $this->productQueryService->list(['is_new' => true, 'status' => 'active'], 1, 10)['list'];
