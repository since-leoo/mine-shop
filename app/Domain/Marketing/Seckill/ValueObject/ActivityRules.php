...
final class ActivityRules
{
    ...
    public function toArray(): array
    {
        return [
            ...
            'require_member_level' => $this->requireMemberLevel,
            'required_member_level_id' => $this->requiredMemberLevelId,
            'allow_refund' => $this->allowRefund,
