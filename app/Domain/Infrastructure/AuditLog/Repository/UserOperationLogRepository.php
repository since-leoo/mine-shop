...
namespace App\Domain\Infrastructure\AuditLog\Repository;
...
{
    public function __construct(protected readonly UserOperationLog $model) {}
    ...
    public function deleteByIds(mixed $ids): int
    {
