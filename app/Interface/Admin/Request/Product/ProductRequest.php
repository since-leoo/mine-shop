...
class ProductRequest extends BaseRequest
{
    ...
    private function baseRules(): array
    {
        return [
            ...
            'flat_freight_amount' => ['nullable', 'integer', 'min:0', 'max:99999', 'required_if:freight_type,flat'],
            'shipping_template_id' => ['nullable', 'integer', 'min:1', 'required_if:freight_type,template', 'exists:shipping_templates,id'],
