...
use App\Application\Admin\Organization\AppDepartmentCommandService;
use App\Application\Admin\Organization\AppDepartmentQueryService;
...
class DepartmentController extends AbstractController
{
    public function __construct(
        ...
        protected readonly AppDepartmentQueryService $queryService,
        protected readonly AppDepartmentCommandService $commandService
    ) {}
    ...
    {
        return $this->success([
            'list' => $this->queryService->getList($this->getRequestData()),
        ]);
    }
