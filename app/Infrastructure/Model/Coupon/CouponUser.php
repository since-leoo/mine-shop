...
class CouponUser extends Model
{
    ...
    protected array $fillable = [
        'coupon_id', 'member_id', 'order_id', 'status', 'received_at', 'used_at', 'expire_at',
    ];

    protected array $casts = [
        'coupon_id' => 'integer', 'member_id' => 'integer', 'order_id' => 'integer',
        'received_at' => 'datetime', 'used_at' => 'datetime', 'expire_at' => 'datetime',
