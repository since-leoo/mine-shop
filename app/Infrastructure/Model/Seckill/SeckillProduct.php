...
class SeckillProduct extends Model
{
    ...
    protected array $fillable = [
        'activity_id', 'session_id', 'product_id', 'product_sku_id',
        'original_price', 'seckill_price', 'quantity', 'sold_quantity',
        'max_quantity_per_user', 'sort_order', 'is_enabled',
    ];

    protected array $casts = [
        'activity_id' => 'integer', 'session_id' => 'integer',
        'product_id' => 'integer', 'product_sku_id' => 'integer',
        'original_price' => 'integer', 'seckill_price' => 'integer',
        'quantity' => 'integer', 'sold_quantity' => 'integer',
        'max_quantity_per_user' => 'integer', 'sort_order' => 'integer',
