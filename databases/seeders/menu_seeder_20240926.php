            ...
            [
                ...
                'children' => [
                    ...
                    [
                        ...
                        'meta' => new Meta([
                            'title' => '拼团订单',
                            'i18n' => 'mallMenu.mall.groupBuyOrder',
                            'icon' => 'ph:users-three',
                            'hidden' => 0,
                            'type' => 'M',
                            'componentPath' => 'modules/',
                        ...
                        'children' => [
                            [
                                'name' => 'promotion:group_buy_order:list',
                                'meta' => new Meta([
                                    'title' => '拼团订单列表',
                                    'type' => 'B',
                                    'i18n' => 'mallMenu.mall.groupBuyOrderList',
                                ]),
                            ],
                        ],
                    ],
                    [
                        'name' => 'mall:seckill_order',
                        'path' => '/mall/seckill-order',
                        'component' => 'mall/views/seckill-order/index',
                        'meta' => new Meta([
                            'title' => '秒杀订单',
                            'i18n' => 'mallMenu.mall.seckillOrder',
                            'icon' => 'ph:lightning',
                            'hidden' => 0,
                            'type' => 'M',
                            'componentPath' => 'modules/',
                        ...
                        'children' => [
                            [
                                'name' => 'promotion:seckill_order:list',
                                'meta' => new Meta([
                                    'title' => '秒杀订单列表',
                                    'type' => 'B',
                                    'i18n' => 'mallMenu.mall.seckillOrderList',
                                ]),
                            ],
                        ],
                    ],
